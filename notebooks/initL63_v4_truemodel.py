...
def main(output_path, use_true_model=False, t_warmup=1, obs_noise_sd_true=1, traindata_ind=1, testdata_ind=1, trainseed=0, da_seed=0,
	...
	model, modelRINN = get_NbedDyn_model(params, use_true_model=use_true_model)
...
def big_runner(runtype='time', output_nm='../ic_outputs_L63/default_output',
	...
	for j in tqdm(job_inds):
		...
		# run!
		eval_dict = main(output_path=output_nm, thresh_list=thresh_list, use_true_model=use_true_model, **run_dict)
...
if __name__ == '__main__':
	output_nm = '../ic_outputs_L63/experiment1_redo_TRUEMODEL/'
